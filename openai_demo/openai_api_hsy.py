...
# MODEL_PATH = "/home/huangshiyu/mfs_v2/Download/modelzoo/modelscope/cogagent-chat"
# PORT=64135
MODEL_PATH = "/home/huangshiyu/mfs_v2/Download/modelzoo/modelscope/cogvlm-chat"
PORT=64136

TOKENIZER_PATH = "/home/huangshiyu/mfs_v2/Download/modelzoo/huggingface/vicuna-7b-v1.5_only_tokenizer"
            ...
            for item in content:
                if isinstance(item, ImageUrlContent):
                    ...
                    if image_url.startswith("data:image/jpeg;base64,"):
                        ...
                        base64_encoded_image = image_url.split("data:image/jpg;base64,")[1]
                        image_data = base64.b64decode(base64_encoded_image)
                        image = Image.open(BytesIO(image_data)).convert('RGB')
                        image_list.append(image)
                    elif image_url.startswith("data:image/gif;base64,"):
                        base64_encoded_image = image_url.split("data:image/gif;base64,")[1]
                        image_data = base64.b64decode(base64_encoded_image)
                        image = Image.open(BytesIO(image_data)).convert('RGB')
                        image_list.append(image)
...
if __name__ == "__main__":
    ...
    print("QUANT_ENABLED:{}, DEVICE:{}".format(QUANT_ENABLED, DEVICE))
    print("Model Name: {}".format(MODEL_PATH.split('/')[-1]))
    if 'cuda' in DEVICE:
        if QUANT_ENABLED:
